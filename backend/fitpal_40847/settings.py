"""
Django settings for fitpal_40847 project.
...
ROOT_URLCONF = 'fitpal_40847.urls'
...
WSGI_APPLICATION = 'fitpal_40847.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fitpal_40847 API",
    "DESCRIPTION": "API documentation for fitpal_40847 App",
    "VERSION": "v1",
}
